...
class SimpleTestRunner {
    ...
    async runTest() {
        ...
        try {
            ...
            const shooterData = {
                shooter_name: 'IR Grid Demo User',
                email: 'demo@irtest.com',
                phone: '555-DEMO',
                skill_level: 'intermediate',
                notes: 'IR Grid Demo Shooter for testing'
            };
            ...
            const sessionData = {
                ...
                lane_id: 'lane1',
                session_name: 'IR Grid Demo Session'
            };
    ...
    async runBatchTest() {
        ...
        try {
            ...
            const shooterResult = await this.makeRequest('POST', '/api/shooters', {
                shooter_name: 'Batch Test User',
                email: 'batch@test.com',
                phone: '555-BATCH',
                skill_level: 'advanced',
                notes: 'Batch Test User for IR Grid testing'
            });
